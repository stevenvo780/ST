# `reasoning/belief-revision/types.ts`
...
- [`BeliefSet`](#beliefset) — Interface
- [`PartialOrder`](#partialorder) — Type
- [`PropFormula`](#propformula) — Type

## `BeliefSet`

> Interface · `reasoning/belief-revision/types.ts:14`
...
> Type · `reasoning/belief-revision/types.ts:25`
...
> Type · `reasoning/belief-revision/types.ts:34`
...
```ts
export type PropFormula = | { kind: 'true' } | { kind: 'false' } | { kind: 'atom'; name: string } | { kind: 'not'; arg: PropFormula } | { kind: 'and'; left: PropFormula; right: PropFormula } | { kind: 'or'; left: PropFormula; right: PropFormula } | { kind: 'implies'; left: PropFormula; right: PropFormula } | { kind: 'iff'; left: PropFormula; right: PropFormula };
```
